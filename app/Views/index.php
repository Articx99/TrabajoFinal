...
<form class="row row-cols-lg-auto g-3 justify-content-center align-items-center mb-4 pb-2" action="/save" method="post">
    <div class="col d-flex justify-content-between">
        <div class="form-outline flex-grow-1 me-1 mx-1">
            ...
            <p class="text-danger mb-0">
                <?php echo isset($errores['task']) ? $errores['task'] : ''; ?>
            </p>
        ...
        <div class="col-auto">
            <button type="submit" class="btn btn-primary form-control" <?php echo count($etiquetas) > 0 ? '' : 'disabled';?>>Guardar</button>
        </div>
    </div>
</form>
...
<?php if (count($tareas) > 0): ?>
    ...
    <?php foreach ($tareas as $etiqueta => $tarea): ?>
        <?php if (count($tarea) > 0) {
            ...
            ?>
            <div id="<?php echo 'mainDiv' . $tarea[0]['id_etiqueta'] ?>">
                <br>
