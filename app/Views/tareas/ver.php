                        ...
                        <?php foreach ($tareas as $tarea): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('delete/' . $tarea['id']) ?>" class="btn btn-danger"
                                        type="button">Delete</a>
                                    <a href="<?= base_url('edit/' . $tarea['id']) ?>" class="btn btn-info"
                                        type="button">Editar</a>
                                    <a href="<?= base_url('view/' . $tarea['id']) ?>" class="btn btn-success ms-1"
                                        type="button">Finished</a>
