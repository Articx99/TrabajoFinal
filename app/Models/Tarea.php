...
class Tarea extends Model{
    ...
    function getActive(){      
        $result= $this->query('SELECT tareas.*, aux_estados.nombre_estado, usuarios.username FROM tareas LEFT JOIN aux_estados ON tareas.id_estado = aux_estados.id_estado LEFT JOIN usuarios ON tareas.id_usuario = usuarios.id_usuario WHERE tareas.id_estado != 3 AND tareas.id_estado != 2 ORDER BY id_usuario, id')->getResultArray();           
        return $result;
    }
